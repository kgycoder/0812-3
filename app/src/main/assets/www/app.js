...
setTimeout(() => {
    loadRec('pop music 2024 official', 'rec-row');
    loadRec('kpop 2024 mv official', 'hot-row');
    loadRec('new music release 2025 official', 'new-row');
    loadRec('best playlist mix official audio', 'pick-row');
}, 700);
